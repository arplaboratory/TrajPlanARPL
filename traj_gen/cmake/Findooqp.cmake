...
message(WARNING $ENV{PLATFORM_TYPE} )

#set(GFORTRAN_DIR /usr/lib/gcc/x86_64-linux-gnu/7/) #x86 PC LIBRARY
if (CMAKE_VERSION VERSION_LESS 2.8.12)
	message(WARNING "Dragonfly" )
       	set(GFORTRAN_DIR /usr/lib/gcc/arm-linux-gnueabihf/4.8/) # Dragonfly LIBRARY 
  find_library(LIB_GFORTRAN NAMES gfortran HINTS ${GFORTRAN_DIR})
...
find_library(LIB_MA27 NAMES ma27 HINTS ${LIB_DIR})
find_library(LIB_GFORTRAN NAMES gfortran HINTS ${GFORTRAN_DIR})
set(OOQP_LIBRARY ${OOQP_BASE} ${OOQP_DENSE} ${OOQP_GENSPARSE} ${OOQP_MEHROTRA} ${OOQP_BOUND} ${OOQP_GENDENSE} ${OOQP_GONDZIO} ${OOQP_SPARSE} ${LIB_MA27} ${LIB_GFORTRAN}
)
elseif("$ENV{PLATFORM_TYPE}" STREQUAL "race")
	message(WARNING "race platform" )
	set(GFORTRAN_DIR /usr/lib/gcc/aarch64-linux-gnu/7/) # Dragonfly LIBRARY
  find_library(LIB_GFORTRAN NAMES gfortran HINTS ${GFORTRAN_DIR})
find_library(OOQP_BASE NAMES ooqpbase HINTS ${LIB_DIR})
find_library(OOQP_DENSE NAMES ooqpdense HINTS ${LIB_DIR})
find_library(OOQP_GENSPARSE NAMES ooqpgensparse HINTS ${LIB_DIR})
...
set(OOQP_LIBRARY ${OOQP_BASE} ${OOQP_DENSE} ${OOQP_GENSPARSE} ${OOQP_MEHROTRA} ${OOQP_BOUND} ${OOQP_GENDENSE} ${OOQP_GONDZIO} ${OOQP_SPARSE} ${LIB_MA27} ${LIB_GFORTRAN}
        ...
        message(WARNING "general installation" )
...
set(OOQP_LIBRARY ${OOQP_BASE} ${OOQP_DENSE} ${OOQP_GENSPARSE} ${OOQP_MEHROTRA} ${OOQP_BOUND} ${OOQP_GENDENSE} ${OOQP_GONDZIO} ${OOQP_SPARSE} ${LIB_MA27})
